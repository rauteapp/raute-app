...
export default function WelcomeSetupPage() {
    ...
    useEffect(() => {
        async function initRecovery() {
            // ALWAYS sign out any existing session first (e.g. the manager who
            // created this driver might be logged in on this browser). This
            // prevents the manager's session from leaking into the welcome page.
            try {
